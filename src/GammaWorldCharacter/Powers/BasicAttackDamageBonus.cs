...
{
    /// <summary>
    /// The damage bonus for a <see cref="BasicAttack"/>.
    /// </summary>
    public class BasicAttackDamageBonus: WeaponDamageBonus
    {
        /// <summary>
        /// Create a new <see cref="BasicAttackDamageBonus"/>.
        /// </summary>
        public BasicAttackDamageBonus()
            : base("Basic Attack damage bonus", new ScoreType[0], Hand.Main, 1)
        {
            // Do nothing
        }
