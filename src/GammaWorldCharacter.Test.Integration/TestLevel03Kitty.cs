...
namespace GammaWorldCharacter.Test.Integration
{
    ...
    /// </summary>
    [TestFixture]
    public class TestLevel03Kitty : CharacterTest
    {
        ...
        [TestCase(typeof(GammaWorldCharacter.Powers.Origins.ShareStrength), "One target of your choice takes 10 psychic damage and the other target regains 10 hit points and makes a saving through.")]
        ...
        [TestCase(typeof(GammaWorldCharacter.Powers.Origins.ShareStrength), ActionType.Standard, AttackType.Close, "burst 5", 256, "One target of your choice takes 10 psychic damage and the other target regains 10 hit points and makes a saving through.", 1, PowerFrequency.Encounter, PowerSource.Psi, null)]
        ...
        protected override Character Character
        {
            get
            {
                ...
                {
                    testCharacter = Level03Characters.Kitty;
                }
