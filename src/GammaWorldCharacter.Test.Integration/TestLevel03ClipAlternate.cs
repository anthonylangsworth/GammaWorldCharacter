...
namespace GammaWorldCharacter.Test.Integration
{
    ...
    /// </summary>
    [TestFixture]
    public class TestLevel03Clip__Alternate_ : CharacterTest
    {
        ...
        [TestCase(typeof(GammaWorldCharacter.Powers.Origins.HardToKill), "You regain 13 hitpoints.")]
        ...
        [TestCase(typeof(GammaWorldCharacter.Powers.Origins.HardToKill), ActionType.ImmediateInterrupt, AttackType.Personal, null, 0, "You regain 13 hitpoints.", 1, PowerFrequency.Encounter, PowerSource.Bio, "You drop to 0 hit points.")]
        ...
        protected override Character Character
        {
            get
            {
                ...
                {
                    testCharacter = Level03Characters.ClipAlternate;
                }
